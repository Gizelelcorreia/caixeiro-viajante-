...
void  moverOpt(double &custo, vector<int> &rota, const vector<vector<double >> &distance){
   ...
   cout << "\naplicando o 2_Opt..." << endl;
    ...
    while (melhor) {
        ...
        if (melhorCust < custo) {
            ...
            cout << "primeira posicao: " << rota[primeiraPos] << endl;
            cout << "ultima posicao: " << rota[ultimaPos] << endl;
